                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-sm font-bold text-gray-900">{$currency_code} {$expense.amount|number_format:2}</td>
                    ...
                    <tfoot class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-sm font-bold text-gray-900">{$currency_code} {$list_total|number_format:2}</th>
                            <th colspan="3"></th>
                        </tr>
                    </tfoot>
                </table>
