                    ...
                    <div id="offlinePayFields" style="display: none;">
                        ...
                        {if $_c['mpesa_channel_ofline_online'] == 1}
                            <div class="form-group col-12 styled-form-group">
                                ...
                                <div class="col-md-6">
                                    <a href="{$_url}plugin/c2b&kind=register" class="btn styled-btn">Register C2B URLs (this site)</a>
                                    <a href="{$_url}plugin/c2b_hub&kind=register" class="btn styled-btn" style="margin-top:6px;">Register C2B hub URLs (multi-site Paybill)</a>
                                    <small class="form-text text-muted styled-small-text">Save settings first. Use <strong>hub</strong> only on the server that owns the Paybill; copy <code>system/uploads/c2b_hub_routes.sample.json</code> to <code>c2b_hub_routes.json</code> and edit targets.</small>
                                </div>
                            </div>
                        {/if}
